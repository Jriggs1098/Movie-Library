...
var titleBoxObj, suggestBoxObj, dataType;
...
window.onload = function () {
    ...
    //DOM objects
    titleBoxObj = document.getElementById('search-bar');
    suggestBoxObj = document.getElementById('suggestionDiv');
...
function displayTitles(titles) {
    ...
    suggestBoxObj.innerHTML = divContent;
    suggestBoxObj.style.display = 'block';
}
...
function handleKeyUp(e) {
    ...
    if (e.keyCode === 38 && activeTitle > 0) {
        ...
        titleBoxObj.value = activeTitleObj.innerHTML;
        return;
    }
...
function clickTitle(title) {
    ...
    titleBoxObj.value = title.innerHTML;
